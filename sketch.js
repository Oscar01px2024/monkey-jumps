var bananaImage, obstacleImage, obstacleGroup,background,player,player_running,banana,invisground, bananaGroup,obstacle;
var score = 0;
var gameState = 1;
function preload()  {
...
function draw() {
  ...
  if(monkey.isTouching(bananaGroup)&&monkey.scale<.20) {
 score = score+2;
